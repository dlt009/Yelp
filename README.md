...
- [X] Added icons, filter buttons, and made nav bar red to match Yelp's color scheme
- [X] Added refresh controller to reload businesses on pull
...
Couldn't get infinite scroll to work just yet...
